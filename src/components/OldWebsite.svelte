...
<div class="container">
	<div class="section church">
		...
		<div class="polaroid">
			<img src="eglise.jpg" alt="eglise-saint-jean" />
		</div>
	</div>
	<div class="section">
		<div class="polaroid">
			<img
				src="http://domaineduboissaintmard.fr/wp-content/uploads/2017/09/cropped-IMG_1524.jpg"
				alt="Domaine du Bois Saint-Mard"
			/>
		</div>
		<div class="subsection sans">
	...
	<div class="info-section">
		...
		<div class="accomodation-list">
			...
			<div class="accomodation">
				...
				<div class="accomodation-type">Chambres d’hôtes</div>
				<div class="accomodation-city">Couloisy</div>
				<hr />
				<a class="accomodation-site" href="https://www.unairdecampagne.net/"> Site web </a>
				<div class="accomodation-contact">06 19 32 20 87</div>
			</div>
			<div class="accomodation">
				<div class="accomodation-name">Les Araucarias</div>
				<div class="accomodation-type">Camping (mobile-home)</div>
				<div class="accomodation-city">Carlepont</div>
				<hr />
				<div class="accomodation-contact">03 44 75 27 39</div>
			</div>
			<div class="accomodation">
				<div class="accomodation-name">Gîte de Trosly-Breuil</div>
				<div class="accomodation-type">Gîte</div>
				<div class="accomodation-city">Trosly Breuil</div>
				<hr />
				<div class="accomodation-contact">06 23 15 89 79</div>
			</div>
			<div class="accomodation">
				<div class="accomodation-name">Hôtel 2 Vallées</div>
				<div class="accomodation-type">Hôtel</div>
				<div class="accomodation-city">Thourotte</div>
				<hr />
				<a class="accomodation-site" href="https://www.hotel2vallees.com/"> Site web </a>
				<div class="accomodation-contact">03 44 20 42 05</div>
				<div class="accomodation-contact">10 Avenue du Gros Grelot, 60150 Thourotte</div>
				<div class="">à 20 minutes du domaine en voiture</div>
			</div>
			<div class="accomodation">
				<div class="accomodation-name">Le Moulin</div>
				<div class="accomodation-type">Hôtel</div>
				<div class="accomodation-city">Pontoise-lès-Noyon</div>
				<hr />
				<a
					class="accomodation-site"
					href="https://www.booking.com/hotel/fr/le-moulin-pontoise-les-noyon.fr.html"
				>
					Site web
				</a>
...
<!--
 ...
 Hôtel 2 Vallées Thourotte
€55
10 Avenue du Gros Grelot, 60150 Thourotte•03 44 20 42 05
https://www.hotel2vallees.com/
 20 minutes en voiture


  Le Moulin
€68
485 Rue du Moulin, 60400 Pontoise-lès-Noyon•03 44 09 72 57
https://www.booking.com/hotel/fr/le-moulin-pontoise-les-noyon.fr.html
11 minutes en voiture
